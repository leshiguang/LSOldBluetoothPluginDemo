...
const SETTING_ITEM_WIFIConfig = 'Wifi config';
...
Page({
        ...
        onBindingListener = {
            ...
            onBindingCommandUpdate: function(deviceMac, bindCmd) {
                if (bindCmd === LSBluetoothPlugin.Profiles.BindingCmd.InputRandomNumber) {
                    ...
                    console.warn('tjjjjjjjjjjj1', deviceMac, bindCmd);
                }

                console.warn('tjjjjjjjjjjj2', deviceMac, bindCmd);
            },
    ...
    selectSetting: function(e) {
        ...
        } else if (item === SETTING_ITEM_WIFIConfig) {
            wx.navigateTo({
                url: '../wifiConfig/wifiConfig?broadcastId=' + this.data.deviceMac + '&deviceName=' + this.data.deviceName + '&connectId=' + this.data.connectId
            })
        }
    },
